...
| 8d | *Prices, promotions and the assortment itself.* The three that decide what a rep may sell and at what — and the first that are scoped per outlet rather than per tenant | `OFF-03` | 400 |
