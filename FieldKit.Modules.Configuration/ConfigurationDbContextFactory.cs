    ...
    public ConfigurationDbContext CreateDbContext(string[] args)
    {
        var options = new DbContextOptionsBuilder<ConfigurationDbContext>()
            .UseNpgsql(
                ...
                npgsql => npgsql.MigrationsHistoryTable("__EFMigrationsHistory", ConfigurationDbContext.SchemaName))
            .Options;

        return new ConfigurationDbContext(options, new DesignTimeTenantContext());
    }
